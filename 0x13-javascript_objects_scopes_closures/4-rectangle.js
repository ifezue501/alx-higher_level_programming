...
module.exports = class Rectangle {   // This line exports a class called Rectangle to be used in other modules
  ...
  rotate () {   // This code block defines a method called 'rotate' on the Rectangle class
    [this.width, this.height] = [this.height, this.width];  // This line swaps the values of 'width' and 'height' properties of the Rectangle instance using destructuring assignment
  }

  double () {   // This code block defines a method called 'double' on the Rectangle class
    [this.width, this.height] = [this.width * 2, this.height * 2];  // This line doubles the values of the 'width' and 'height' properties of the Rectangle instance using destructuring assignment
  }
};
